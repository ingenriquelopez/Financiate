...
const CrearPlanDeAhorro = ({ showModal, onClose, planToEdit, updatePlans }) => {
  ...
  return (
    <div className={`modalCrearPlan modal fade ${showModal ? 'show' : ''}`} style={{ display: showModal ? 'block' : 'none' }} tabIndex="-1" aria-labelledby="planModalLabel" aria-hidden={!showModal}>
